...
class ResNet(nn.Module):
    ...
    def forward(self, inputs):
        ...
        if self.training:
            ...
            # transformed_anchors.shape == [1,N,M], and scores.shape == [1,N,1]
            # need [N,M] and [N] for torch.ops.nms
            anchors_nms_idx = nms(transformed_anchors.squeeze(0), scores.view(scores.shape[1]), 0.5)
